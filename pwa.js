...
const cacheName = 'LAWk7AndrewGoehl-2021-10-20 15:13:03.001712'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LAWk7AndrewGoehl'.length) === 'LAWk7AndrewGoehl') {
